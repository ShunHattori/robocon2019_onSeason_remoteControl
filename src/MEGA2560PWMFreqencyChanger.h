...
void setPwmFrequencyMEGA2560(int pin, int divisor) {
    ...
    case 2:
        ...
        TCCR3B = TCCR3B  | mode; break;
    case 3:
        TCCR3B = TCCR3B  & 0b11111000;
        TCCR3B = TCCR3B  | mode; break;
    case 4:
        TCCR0B = TCCR0B  & 0b11111000;
        TCCR0B = TCCR0B  | mode; break;
    case 5:
        TCCR3B = TCCR3B  & 0b11111000;
        TCCR3B = TCCR3B | mode; break;
    case 6:
        TCCR4B = TCCR4B  & 0b11111000;
        TCCR4B = TCCR4B  | mode; break;
    case 7:
        TCCR4B = TCCR4B  & 0b11111000;
        TCCR4B = TCCR4B  | mode; break;
    case 8:
    ...
    case 9:
        ...
        TCCR2B = TCCR2B  | mode; break;
    case 10:
        TCCR2B = TCCR2B  & 0b11111000;
        TCCR2B = TCCR2B  | mode; break;
    case 11:
        TCCR1B = TCCR1B  & 0b11111000;
        TCCR1B = TCCR1B  | mode; break;
    case 12:
        TCCR1B = TCCR1B  & 0b11111000;
        TCCR1B = TCCR1B  | mode; break;
    case 13:
    ...
    case 44:
        ...
        TCCR5C = TCCR5C | mode; break;
    case 45:
        TCCR5B = TCCR5B & 0b11111000;
        TCCR5B = TCCR5B | mode; break;
    case 46:
        TCCR5A = TCCR5A & 0b11111000;
        TCCR5A = TCCR5A | mode; break;
    default: return;
    }
    #ifdef DEBUGPRINT
